...
func HandlerUpload(aResponseWriter http.ResponseWriter, aRequest *http.Request) {
	...
	if requestMethod == STR_GET {
		...
		multipartFile, multipartFileHeader, err := aRequest.FormFile(API_KEY_uploadimage)
		if err != nil {
